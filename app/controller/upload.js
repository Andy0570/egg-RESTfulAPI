/*
 * @Author: Hu Qilin
 * @Date: 2019-12-12 16:52:51
 * @Last Modified by: Hu Qilin
 * @Last Modified time: 2019-12-12 17:17:29
 */
...
class UploadController extends Controller {
  ...
  async url() {
    ...
    let res;
    try {
      // 写入文件 const { filename, image} = download.image(options);
